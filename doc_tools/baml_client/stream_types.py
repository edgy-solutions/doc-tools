...
class ManufacturingStep(BaseModel):
    ...
    hazard_class: typing.Optional[typing.Union[types.HazardClass, str]] = Field(default=None, description='Explosives Safety Hazard. If none, leave null.')
    required_cert: typing.Optional[typing.Union[types.PersonnelRole, str]] = Field(default=None, description='Quality/Personnel requirement. If none, leave null.')
    ...
    process_category: typing.Optional[typing.Union[types.ProcessCategory, str]] = Field(default=None, description='The functional category of the manufacturing process.')
