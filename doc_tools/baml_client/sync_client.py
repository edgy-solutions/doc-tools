...
class BamlSyncClient:
    ...
    def ExtractComplianceRules(self, text: str,system_instructions: str,
        ...
        if 'on_tick' in baml_options:
            ...
            __result__ = self.__options.merge_options(baml_options).call_function_sync(function_name="ExtractComplianceRules", args={
    ...
    def ExtractConcepts(self, slide_text: str,system_instructions: str,
        ...
        if 'on_tick' in baml_options:
            ...
            # Original non-streaming code
            __result__ = self.__options.merge_options(baml_options).call_function_sync(function_name="ExtractConcepts", args={
    ...
    def ExtractOutline(self, document_text: str,system_instructions: str,
        ...
        if 'on_tick' in baml_options:
            ...
            # Original non-streaming code
            __result__ = self.__options.merge_options(baml_options).call_function_sync(function_name="ExtractOutline", args={
...
class BamlStreamClient:
    ...
    def ExtractComplianceRules(self, text: str,system_instructions: str,
        baml_options: BamlCallOptions = {},
    ) -> baml_py.BamlSyncStream[stream_types.ComplianceAugmentation, types.ComplianceAugmentation]:
        __ctx__, __result__ = self.__options.merge_options(baml_options).create_sync_stream(function_name="ExtractComplianceRules", args={
            "text": text,"system_instructions": system_instructions,
        })
        return baml_py.BamlSyncStream[stream_types.ComplianceAugmentation, types.ComplianceAugmentation](
          __result__,
    ...
    def ExtractConcepts(self, slide_text: str,system_instructions: str,
        baml_options: BamlCallOptions = {},
    ) -> baml_py.BamlSyncStream[stream_types.SlideAugmentation, types.SlideAugmentation]:
        __ctx__, __result__ = self.__options.merge_options(baml_options).create_sync_stream(function_name="ExtractConcepts", args={
            "slide_text": slide_text,"system_instructions": system_instructions,
        })
        return baml_py.BamlSyncStream[stream_types.SlideAugmentation, types.SlideAugmentation](
          __result__,
    ...
    def ExtractOutline(self, document_text: str,system_instructions: str,
        ...
        __ctx__, __result__ = self.__options.merge_options(baml_options).create_sync_stream(function_name="ExtractOutline", args={
            "document_text": document_text,"system_instructions": system_instructions,
        })
        return baml_py.BamlSyncStream[stream_types.Outline, types.Outline](
          __result__,
    ...
    def ExtractParts(self, ocr_text: str,html_table: str,table_images: typing.List[baml_py.Image],system_instructions: str,
        baml_options: BamlCallOptions = {},
    ) -> baml_py.BamlSyncStream[typing.List["stream_types.PartRow"], typing.List["types.PartRow"]]:
        __ctx__, __result__ = self.__options.merge_options(baml_options).create_sync_stream(function_name="ExtractParts", args={
            "ocr_text": ocr_text,"html_table": html_table,"table_images": table_images,"system_instructions": system_instructions,
        })
        return baml_py.BamlSyncStream[typing.List["stream_types.PartRow"], typing.List["types.PartRow"]](
          __result__,
...
class BamlHttpRequestClient:
    ...
    def ExtractComplianceRules(self, text: str,system_instructions: str,
        ...
        __result__ = self.__options.merge_options(baml_options).create_http_request_sync(function_name="ExtractComplianceRules", args={
            "text": text,"system_instructions": system_instructions,
        }, mode="request")
        return __result__
    def ExtractConcepts(self, slide_text: str,system_instructions: str,
