...
- Qualification vehicles, qualification samples, evaluation devices, or "qual" parts cited in a process/change notice are NOT replacements — do NOT put them in replacement_mpn. replacement_mpn is only a recommended replacement/substitute for a discontinued part. A process-change (PCN) notice usually has NO replacements: leave replacement_mpn null.
